    ...
    <div className={styles.home}>
      <section className={styles.hero}>
        <div className={styles['hero-text-container']}>
          ...
          <Link
            className="btn light"
            to={isAuthenticated ? '/my-gear-lists/new' : '/my-gear-lists'}
          >
            CREATE GEAR LIST
          </Link>
        </div>
      ...
      <section className={`${styles['info-section']}`}>
        <div className="content-container flex-content-container">
          ...
          <p>
            Each adventure has its own unique challenges and gear requirements. Create multiple
            customized gear lists so you're prepared for whatever comes your way.
          </p>
          <p>
